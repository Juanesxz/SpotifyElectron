...
function ButtonResetSendEmailVerification(props) {
  ...
  return (
    <div className="resend-verification-email">
      <p>
        Si no has resibido el email de verificacion puedes volver a enviarlo
...
function handlerErrors(code) {
  switch (code) {
    ...
    case "auth/too-many-requests":
      toast.warning(
        "Has enviado demasiados solicitudes de reenvio de email de confirmacion en muy poco tiempo"
      );
      break;
